        ...
        <div className="grid grid-cols-12 gap-3 auto-rows-[50%]">
          {randomCardIds.map((cardId, index) => (
            ...
            >
              ...
              <div className="relative h-[40px] w-[100%] top-[360px] rounded-md bg-[#957046] m-auto z-30" />
              {/* <button
                type="button"
              ...
              <button className="absolute w-[60%] flex items-center justify-center left-[19%] top-[120%] rotate-[3deg]  bg-[#C9B080] border-[#A67C4E]  font-medium rounded-lg text-2xl px-5 py-2 mt-4 border-[7px]  text-white  transition active:scale-95 z-50">
                <img src="/assets/icon-coin.svg" width={25} height={25} alt="Coins" className="inline-block mr-3"/>
                300 coins
              </button>
