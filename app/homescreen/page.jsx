...
import GameTitle from "@/components/ui/game-title.jsx"
...
export default function HomeScreen() {
    ...
    return (
        <>
            <main className="min-h-screen bg-indigo-950 flex flex-col p-4 md:p-10">
                {/* Top Navigation */}
                <GameNavBar />
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    {/* Profile Card
                    <ProfileCard id="92734239" username="Shin" /> */}

                    {/* Leaderboard */}
                    <HomeLeaderboard  />
                    </div> 
                    {/* entries={[]} */}
                    {/* Right Column - Game Logo & Content */}
                    <div className="md:w-2/3 flex flex-col items-center justify-between">
                    {/* Game Content Area */}
                    <div className="w-full bg-gray-300 border-4 border-mint-green/50 rounded-lg h-48 mb-6"></div>

                    {/* Game Logo */}
                    <GameTitle />
{/*{onPlay={handlePlay}}*/}
                    {/* Bottom Content Area */}
                    <div className="w-full bg-gray-200 rounded-lg h-48"></div>
                    </div>
                </div>
                </main>
        </>
