    ...
    <DndProvider backend={HTML5Backend}>
      <div className="h-screen w-screen flex fade-in bg-gradient-to-b from-accent to-accent2 relative overscroll-y-none">
        <div className="">
          ...
          {/* Add buttons below */}
          <div className="absolute top-[680px] left-[12%] w-[40%]">
            <Link href="/battle">
              <button
                type="button"
                className="absolute w-[25%] top-[115%] left-[33%] flex items-center justify-center bg-[#0B0C2A] text-white hover:text-[#0B0C2A] border-[#C4F7BC] hover:[#0B0C2A] hover:bg-[#C4F7BC] active:ring-4 active:ring-[#C4F7BC] active:outline-none font-medium rounded-lg text-4xl px-5 py-1.5 mt-2 border-4"
              >
                Ready
              </button>
            </Link>
